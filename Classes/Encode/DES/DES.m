...
+ (NSData *)TripleDataDES:(NSData*)data encryptOrDecrypt:(CCOperation)encryptOrDecrypt key:(NSString*)key
{
...
{
    return [DES TripleDataDES:data encryptOrDecrypt:kCCEncrypt key:SECRET_KEY];
}
+ (NSData *)decryptData:(NSData *)data
{
    return [DES TripleDataDES:data encryptOrDecrypt:kCCDecrypt key:SECRET_KEY];
}
